 ...
 *
 * @RestResource(
 *   id = "pigeons_create_rest_resource",
 *   label = @Translation("Pigeons create rest resource"),
 *   uri_paths = {
 *     "create" = "/api/v1/pigeons/create"
 *   }
 * )
 */
class PigeonsCreateRestResource extends ResourceBase {
  ...
  /**
   * Constructs a new PigeonsCreateRestResource object.
   *
