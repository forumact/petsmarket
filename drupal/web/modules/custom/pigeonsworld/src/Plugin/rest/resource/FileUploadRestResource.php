 ...
 *
 * @RestResource(
 *   id = "file_upload_rest_resource",
 *   label = @Translation("File upload rest resource"),
 *   uri_paths = {
 *     "create" = "/api/v1/file/upload/{entity_type_id}/{bundle}/{field_name}"
 *   }
 * )
 */
class FileUploadRestResource extends ResourceBase {
