 ...
 */
class LoginRestController extends ControllerBase implements ContainerInjectionInterface {
  ...
  public function login(Request $request) {
    ...
    // throw new BadRequestHttpException('Sorry, unrecognized name or pass.');.
    $response_data['invalid'] = 'Sorry, unrecognized name or pass.';
    $encoded_response_data = $this->serializer->encode($response_data, $format);
    return new Response($encoded_response_data);
  }
